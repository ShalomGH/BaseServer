"""
Django settings for base_server project.
...
WSGI_APPLICATION = 'base_server.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        'create_model_color': {
            '()': 'base_server.logger.CreationFormatter',
        },
        'color_verbose': {
            '()': 'base_server.logger.CustomFormatter',
            'colored': True
        },
        'colorless_verbose': {
            '()': 'base_server.logger.CustomFormatter',
    ...
    'filters': {
        'without_get': {
            '()': 'base_server.logger.SkipStaticFilter'
        }
    },
    'handlers': {
        'console': {
